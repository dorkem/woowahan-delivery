...
INSERT INTO stores (store_id, owner_user_id, store_name, business_number, store_address, store_address_details, status, min_order_amount, base_delivery_fee, created_at)
VALUES (1, 1, 'BBQ', '123-45-67890', '서울특별시 강남구', '15층', 'OPEN', 15000, 3000, NOW());

INSERT INTO menus (menu_id, store_store_id, menu_name, menu_description, price, created_at)
