...
INSERT INTO stores (store_id, owner_id, store_name, business_number, store_address, store_address_details, status, min_order_amount, base_delivery_fee, created_at)
